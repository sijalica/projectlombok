...
import com.spring.projectlombok.services.BeerServiceImpl;
...
class BeerControllerTest {
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.createBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, null, 1, 25).getContent().get(1));
    ...
    @Test
    void testUpdateBeerNotBlank() throws Exception {
        BeerDTO beer = beerServiceImpl.listBeers(null, null, null, 1, 25).getContent().get(0);
        beer.setBeerName("");
